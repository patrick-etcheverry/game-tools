...
game-tools est un petit module C++ contenant des sous-programmes utiles pour développer des petits jeux s'exécutant dans une console. Ce module est mis à disposition des étudiants dans le cadre de la SAE 1.1 Implémentation d'un besoin client.

Cette version du module `game-tools` n'est utilisable que sur des systèmes d'exploitation **windows**.

La documentation Doxygen du projet est disponible sur <a href="https://patrick-etcheverry.github.io/game-tools/files.html">cette page</a>.
